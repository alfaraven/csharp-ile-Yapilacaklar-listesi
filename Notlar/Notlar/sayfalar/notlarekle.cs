...
{
    public partial class notlarekle : UserControl
    {
        ...
        private void guna2GradientButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                MySqlCommand cmd = new MySqlCommand("Insert into notlarim (user_id,not_baslik,not_icerik,not_oncelik,not_durum)  values(@usr_id,@baslik,@icerik,@oncelik,@durum)", con);
        ...
        private void notlarekle_Load(object sender, EventArgs e)
        {
